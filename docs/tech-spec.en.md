...
- **Status**: S1 (pure engine), S2 (static canvas), and **S3 (a playable single battle: mouse + keyboard, enemy AI, win/lose)** done; next is tweens/effects, multiple maps, damage preview, and other polish.
...
- Introduced integration tests (17 → 586); CI gates on typecheck, lint, test, and image build
